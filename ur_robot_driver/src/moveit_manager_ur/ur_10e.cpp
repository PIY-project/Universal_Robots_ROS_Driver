...
bool moveitManagerUR10e::customSingularityRecoveryPlan(const std::vector<geometry_msgs::Pose> &waypointsPose, trajSettings &traj_settings, errorCode &error, planningResult &planning_result, const rpwc_msgs::RobotArmStateStamped& robot_state, const std::vector<double>* initialJointConfig)
{
